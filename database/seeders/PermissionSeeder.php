...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'providers.view', 'display_name' => 'View Providers', 'description' => 'Can view provider list and details', 'group' => 'providers'],
            ['name' => 'providers.create', 'display_name' => 'Create Providers', 'description' => 'Can create new providers', 'group' => 'providers'],
            ['name' => 'providers.edit', 'display_name' => 'Edit Providers', 'description' => 'Can edit existing providers', 'group' => 'providers'],
            ['name' => 'providers.delete', 'display_name' => 'Delete Providers', 'description' => 'Can delete providers', 'group' => 'providers'],
